document.addEventListener("DOMContentLoaded", function() {
    console.log('phrasal_verbs.js script loaded');

    const questionsContainer = document.getElementById('questionsContainer-phrasal_verbs');
    const submitButton = document.getElementById('submitButton-phrasal_verbs');
    const nameInput = document.getElementById('name-phrasal_verbs');
    let questions;
    ...
    function fetchQuestions() {
        fetch('https://my-postgres-server.vercel.app/phrasal_verbs')
            .then(res => res.json())
            .then(data => {
                questions = data;
                displayQuestions();
    ...
    function submitForm(nameInput, score) {
        ...
        fetch('https://my-postgres-server.vercel.app/data', {
            ...
            body: JSON.stringify({
                ...
                score: score,
                subject: 'phrasal_verbs' // Corrected assignment operator
            })
        })
