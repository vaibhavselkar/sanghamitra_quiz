document.addEventListener("DOMContentLoaded", function() {
    ...
    function fetchQuestions() {
        ...
        fetch('https://my-postgres-server.vercel.app/prepo-time')
            .then(res => res.json())
            .then(data => {
    ...
    submitButton.addEventListener('click', (event) => {
        ...
        feedbackLink.classList.add('btn', 'btn btn-outline-success');
        ...
        statisticsButton.classList.add('btn', 'btn btn-outline-success', 'mx-2');
        ...
        homeButton.classList.add('btn', 'btn btn-outline-success');
        homeButton.onclick = function() {
            window.location.href = '../grammar.html'; // Replace 'index.html' with your actual home page URL
        };
    ...
    function submitForm(nameInput, score) {
        fetch('https://my-postgres-server.vercel.app/data', {
            ...
            body: JSON.stringify({
                ...
                score: score,
                subject: 'preposition-time', // Corrected assignment operator
