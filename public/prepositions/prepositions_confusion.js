document.addEventListener("DOMContentLoaded", function() {
    console.log('prepositions.js script loaded');
    ...
    function fetchQuestions() {
        ...
        fetch('https://my-postgres-server.vercel.app/prepo-confusion')
            .then(res => res.json())
            .then(data => {
    ...
    function submitForm(nameInput, score) {
        fetch('https://my-postgres-server.vercel.app/data', {
            ...
            body: JSON.stringify({
                ...
                score: score,
                subject: 'confusion between prepositions', // Corrected assignment operator
